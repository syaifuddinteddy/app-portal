...
@section('title_description', 'Prestasi / Penghargaan')
@section('css')
      ...
      <div class="col-md-12">
          <div class="box box-success">
              <div class="box-header with-border">
                  <h3 class="box-title">Edit Profil Prestasi / Penghargaan</h3>
              </div>
                ...
                <form class="form-horizontal" action="/profilSejarah/update" method="post">
                  ...
                  <input type="hidden" name="id" value="5">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea class="ckeditor form-control required" id="editor1" name="narasi" rows="10" cols="80">{{$p->narasi}}</textarea>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea class="ckeditor form-control required" id="editor2" name="narasi_eng" rows="10" cols="80">{{$p->narasi_eng}}</textarea>
                      </div>
                    </div>
