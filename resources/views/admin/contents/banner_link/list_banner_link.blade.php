...
@section('title_description', 'Daftar Banner Link')
@section('css')
        ...
        <div class="col-md-12">
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Data Banner Link</h3>
                    <div class="pull-right">
                        <a href="{{URL::route('bannerLinkAdd')}}"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Banner</button></a>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="tbBanner" class="table table-bordered table-striped table-hover">
                        <thead>
                        <tr>
                            <th class="bg-blue col-md-1">Nama Banner</th>
                            <th class="bg-blue">Kategori</th>
                            <th class="bg-blue col-md-1">Tautan</th>
                        ...
                        @foreach($banner as $idx => $banner_item)
                            <tr>
                                <td>{{$banner_item->nama_banner}}</td>
                                <td>{{$banner_item->jenis}}</td>
                                <td>{{$banner_item->url}}</td>
                                <td><img src="{{ URL::to('storage/uploads/banner_link/'.$banner_item->file)}}" style="width: 300px; height: 50px"></td>
                                ...
                                <td align="center">
                                    <a class="btn btn-small btn-warning" href="{{ URL::route('bannerLinkEdit', $banner_item->id_banner)}}"><div class="fa fa-pencil"></div></a>
                                    <a class="btn btn-small btn-danger" href="{{ URL::route('bannerLinkDelete', $banner_item->id_banner) }}"><div class="fa fa-trash"></div></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
